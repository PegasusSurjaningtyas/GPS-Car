...
int trigPin = 50;                                                  // Trig - Orange
int echoPin = 51;                                                  // Echo - Yellow
...
float Distance_To_Home;                                    // variable for storing the distance to destination

int ac =0;                                                         // GPS array counter
int wpCount = 0;                                                   // GPS waypoint counter
float Home_LATarray;                                          // variable for storing the destination Latitude - Only Programmed for 5 waypoint
float Home_LONarray;                                          // variable for storing the destination Longitude - up to 50 waypoints
float cur_lat;
float cur_lon;
